<template>
    <div class="contentSection">
        <section class="step3 cid-tuuCRUQAEW" id="step3-1q">
            <div class="container">
                <h2 class="mbr-section-title pb-3 mbr-fonts-style display-5">My Reviews</h2>
                            ...
                            <div class="step-element d-flex">
                                <div class="step-text-content">
                                    ...
                                    <p class="mbr-step-text mbr-fonts-style display-7">
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam erat libero,
                                        bibendum in libero tempor, luctus volutpat ligula. Integer fringilla porttitor
                                        pretium.
                                    </p>
                                </div>
                            </div>
